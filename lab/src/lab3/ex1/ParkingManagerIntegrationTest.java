...
public class ParkingManagerIntegrationTest {
    ...
    public static Collection<Object[]> getTestParameters() {
        return Arrays
                .asList(new Object[][] {
                        { "/lab3.ex1/input/park1.in",
                                "/lab3.ex1/output/park1.out" },
                        { "/lab3.ex1/input/park2.in",
                                "/lab3.ex1/output/park2.out" },
                        { "/lab3.ex1/input/park3.in",
                                "/lab3.ex1/output/park3.out" },
                        { "/lab3.ex1/input/park4.in",
                                "/lab3.ex1/output/park4.out" },
                        { "/lab3.ex1/input/park5.in",
                                "/lab3.ex1/output/park5.out" }, });
    }
