...
public class CDFillingTest {
    ...
    public static Collection<Object[]> getTestParameters() {
        return Arrays.asList(new Object[][] {
                { "/lab5.ex1/input/cd1.in", "/lab5.ex1/output/cd1.out" },
                { "/lab5.ex1/input/cd2.in", "/lab5.ex1/output/cd2.out" },
                { "/lab5.ex1/input/cd3.in", "/lab5.ex1/output/cd3.out" },
                { "/lab5.ex1/input/cd4.in", "/lab5.ex1/output/cd4.out" },
                { "/lab5.ex1/input/cd5.in", "/lab5.ex1/output/cd5.out" }, });
    }
