...
public class GoldHunter {
     ...
     * 
     * Gold values is depends on the neighboring bombs. 
     * The more bombs nearby, the more gold it has.
     * 
     * @param map
     * @return map
     */
     ...
     * Please note however, this function does not validate 
     *    whether the provided row, col in the parameter is a bomb.
     *    Therefore, if the program need to have this restriction, 
     *    do the validation on a separate method before calling this method
     *    
     * as long as you call this method is called
     *    the neighbour gold value increase 
     *    by the GOLD_VALUE_INCREMENT constant
     * 
     * @param row
     * @param col
     * @param map
    ...
    /**
     * We don't have to worry about the bomb character anymore,
     * This method abstract the bomb character.
     * 
     * @param character
     * @return boolean
     */
